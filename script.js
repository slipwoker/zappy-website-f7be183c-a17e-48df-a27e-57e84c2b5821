    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "בפיך ובלבבך לעשתו משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'f7be183c-a17e-48df-a27e-57e84c2b5821',
                    name: data.name || '',
                    email: data.email || '',
